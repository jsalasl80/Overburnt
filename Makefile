...
# Define targets
TARGET = Restaurant
OBJECTS = Accountant.o CSVReader.o Customer.o CustomersInLine.o CustomerSpawner.o Deliverer.o FileWriter.o Ingredient.o Inventory.o InventoryManager.o LineCook.o Menu.o Order.o Random.o Recipe.o RecipeReader.o Restaurant.o ResultsQueue.o Table.o ThreadPoolDeliverers.o ThreadPoolLineCooks.o ThreadPoolTables.o Waiter.o main.o
TEST_SOURCES = test_accountant.cpp test_csvreader.cpp test_customer.cpp test_customersinline.cpp test_customerspawner.cpp test_deliverer.cpp test_filewriter.cpp test_ingredient.cpp test_inventory.cpp test_inventorymanager.cpp test_linecook.cpp test_menu.cpp test_order.cpp test_random.cpp test_recipe.cpp test_recipereader.cpp test_restaurant.cpp test_resultsqueue.cpp test_table.cpp test_threadpooldeliverers.cpp test_threadpoollinecooks.cpp test_threadpooltables.cpp test_waiter.cpp
